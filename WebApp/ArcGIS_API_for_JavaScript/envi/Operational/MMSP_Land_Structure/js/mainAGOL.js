...
function zoomToLayer(layer) {
  ...
  am4core.ready(function() {
    ...
    // When land type is changed, station is reset to 'None'
  ...
  view.when(() => {
    ...
    document.querySelector("#item-description").innerHTML = `1. You can opt for either <b>light theme or dark theme</b> for a window screen via a switch icon in the upper right.<br>
                                                             2. You can <b>filter the data</b> by land type (station or subterranean) and section using dropdown lits.<br>
                                                             3. Toggle a checkbox at the bottom of 'Land' panel to view handed-over lots.<br>
                                                             3. You can view summary statistics and progress on acquisition of land/structure in charts.<br>
                                                             4. Click the sliced inside the pie charts to view the selected lots/structures on the map. 
                                                             4. Lots under expropriation is available in the 'Expro List' tab under the theme switch.<br>
