...
import DataContext from './DropDownFilter';
import LotChart from '../chart/LotChart';
import { generateLotData, generateLotMoaData, generateLotNumber } from './Query';
...
export default function Statistics({ value, setLotNumber }: Props) {
  ...
  return (
    <>
      <LotChart chartID="pie-two" data={lotData} lotNumber={value} />
    </>
  );
}
